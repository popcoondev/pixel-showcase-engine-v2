      ...
      <div className="help-card legal-card" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="legal-body">
          ...
          <ul>
            ...
            <li>
              <b>アクセス解析</b>: クッキーを使わないアクセス解析(Cloudflare Web Analytics)を利用し、訪問数・閲覧ページ・流入元などの<b>集計値のみ</b>を把握します。クッキーや個人を特定する仕組みは使用しません。
            </li>
            <li>
              <b>エラー監視</b>: 不具合の改善のため、エラー発生時の技術情報(発生箇所・ブラウザ等)をエラー監視サービス(Sentry)を通じて収集することがあります。
            </li>
            <li>
